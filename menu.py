        ...
        while running:
            ...
            if self.game_paused == True:
                ...
                if self.menu_state == "music":
                    pygame.draw.line(
                        self.screen, (255, 0, 0), (150, 500), (450, 500), 5
                    )
                    volume_button = pygame.draw.circle(
                        self.screen, (255, 255, 0), (self.VPOS, 500), 10, width=0
                    )
                    volume_state = 0
                ...
                self.draw_text(
                    "Welcome to the Rummic game!", self.font, Menu.TEXT_COL, 160, 250
                )
...
class Menu:
    ...
    def draw_text(self, text, font, text_col, x, y):
        img = font.render(text, True, text_col)
        self.screen.blit(img, (x, y))
>>>>>>> f9b2782f11e6945a1a1d8a83069b329365a2b025
>>>>>>> 7dc24fbfffc76bf0cae94d474047b6e1c8d3736b
